...
import { FormField, FormItem, FormLabel, FormMessage, Form, FormControl } from "agentview/components/ui/form";
import { Input } from "agentview/components/ui/input";
import { Button } from "agentview/components/ui/button";
import { UserMessage, AssistantMessage, StepItem, UserMessageInput } from "agentview/components/session-item";
...
export default defineConfig({
    ...
    agents: [
        {
            name: "simple_chat",
            url: "http://localhost:3000/agentview/run",
            run: {
                input: {
                    type: "message",
                    role: "user",
