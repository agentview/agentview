...
import { Experimental_Agent as Agent, tool, convertToModelMessages, streamText, stepCountIs, consumeStream } from 'ai';
import { z } from 'zod';
...
app.post('/chat/simple', async (c) => {
  ...
  return result.toUIMessageStreamResponse({
    onFinish: async ({ messages, isAborted, finishReason }) => {
      console.log('onFinish (is aborted:', isAborted, ', finish reason:', finishReason, ')');
