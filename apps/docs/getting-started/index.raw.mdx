...
<Prompt>
  - Generate a Typescript code block with code from apps/demo/agent-typescript/src/index.ts
  - highlight the parts related to AgentView (in Mintlify syntax): AgentView instance creation and calls to AgentView SDK.
</Prompt>
