...
AgentView solves not an AI part, but "everything around the AI" part.
...
**AgentView is a hosted backend for conversational agents** that handles such problems for you. Here's how you can add persistence to your Chat Endpoint:
...
We also need to register `my_agent` in the AgentView configuration file:
