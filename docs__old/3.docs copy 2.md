...
All you need to do is create such token with external user platform id, sign it with your AgentView private key, and send it via `id_token`. This will allow AgentView to find a correct user based on `external_id`.
